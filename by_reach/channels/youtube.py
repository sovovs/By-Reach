...
class YouTubeChannel(Channel):
    ...
    def check(self, config=None):
        ...
        if not has_js:
            return "warn", (
                ...
                "  安装 Node.js 或 deno，然后运行：by-reach install --system"
            )
    ...
    def transcribe(
        ...
        *,
        ...
        Delegates to :func:`by_reach.transcribe.transcribe`. Imported lazily
        so the channel module stays cheap to import for users who never
        transcribe.
        """
        from by_reach.transcribe import transcribe as _transcribe
