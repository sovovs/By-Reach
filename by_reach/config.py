# -*- coding: utf-8 -*-
"""Configuration management for By-Reach.

Stores settings in ~/.by-reach/config.yaml. Reads never create files or
...
from by_reach.identity import CONFIG_DIRNAME
...
class Config:
    """Manages By-Reach configuration."""
